...
class configuration_rename_app_request;

class configuration_rename_app_response;
...
typedef struct _configuration_query_by_node_request__isset {
  _configuration_query_by_node_request__isset() : node(false), stored_replicas(false), info(false), partition_storage(false), disk_storage(false) {}
  bool node :1;
  bool stored_replicas :1;
  bool info :1;
  bool partition_storage :1;
  bool disk_storage :1;
...
class configuration_query_by_node_request {
 public:
  ...
  std::map< ::dsn::gpid, int32_t>  partition_storage;
  std::map<std::string, int32_t>  disk_storage;
  ...
  void __set_partition_storage(const std::map< ::dsn::gpid, int32_t> & val);

  void __set_disk_storage(const std::map<std::string, int32_t> & val);
  ...
  bool operator == (const configuration_query_by_node_request & rhs) const
  {
    ...
    if (__isset.info != rhs.__isset.info)
      ...
      return false;
    if (!(partition_storage == rhs.partition_storage))
      return false;
    if (!(disk_storage == rhs.disk_storage))
      return false;
    return true;
  }
  bool operator != (const configuration_query_by_node_request &rhs) const {
...
typedef struct _configuration_rename_app_request__isset {
  _configuration_rename_app_request__isset() : old_app_name(false), new_app_name(false) {}
  bool old_app_name :1;
  bool new_app_name :1;
} _configuration_rename_app_request__isset;

class configuration_rename_app_request {
 public:

  configuration_rename_app_request(const configuration_rename_app_request&);
  configuration_rename_app_request& operator=(const configuration_rename_app_request&);
  configuration_rename_app_request() : old_app_name(), new_app_name() {
  }

  virtual ~configuration_rename_app_request() throw();
  std::string old_app_name;
  std::string new_app_name;

  _configuration_rename_app_request__isset __isset;

  void __set_old_app_name(const std::string& val);

  void __set_new_app_name(const std::string& val);

  bool operator == (const configuration_rename_app_request & rhs) const
  {
    if (!(old_app_name == rhs.old_app_name))
      return false;
  ...
  bool operator < (const configuration_rename_app_request & ) const;
...
inline std::ostream& operator<<(std::ostream& out, const configuration_rename_app_request& obj)
{
  obj.printTo(out);
  return out;
}

typedef struct _configuration_rename_app_response__isset {
  _configuration_rename_app_response__isset() : err(false), hint_message(false) {}
  bool err :1;
  bool hint_message :1;
} _configuration_rename_app_response__isset;

class configuration_rename_app_response {
 public:

  configuration_rename_app_response(const configuration_rename_app_response&);
  configuration_rename_app_response& operator=(const configuration_rename_app_response&);
  configuration_rename_app_response() : hint_message() {
  }

  virtual ~configuration_rename_app_response() throw();
   ::dsn::error_code err;
  std::string hint_message;

  _configuration_rename_app_response__isset __isset;

  void __set_err(const  ::dsn::error_code& val);

  void __set_hint_message(const std::string& val);

  bool operator == (const configuration_rename_app_response & rhs) const
  {
    if (!(err == rhs.err))
      return false;
    if (!(hint_message == rhs.hint_message))
  ...
  bool operator < (const configuration_rename_app_response & ) const;
...
inline std::ostream& operator<<(std::ostream& out, const configuration_rename_app_response& obj)
{
  obj.printTo(out);
  return out;
}
