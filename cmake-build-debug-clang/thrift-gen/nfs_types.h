...
typedef struct _copy_request__isset {
  _copy_request__isset() : source(false), source_dir(false), dst_dir(false), file_name(false), offset(false), size(false), is_last(false), overwrite(false), source_disk_tag(false), pid(false) {}
  bool source :1;
  bool source_dir :1;
  bool dst_dir :1;
  bool file_name :1;
...
class copy_request {
 public:
  ...
  copy_request() : source_dir(), dst_dir(), file_name(), offset(0), size(0), is_last(0), overwrite(0), source_disk_tag() {
  }
  ...
  void __set_source_disk_tag(const std::string& val);
  ...
  bool operator == (const copy_request & rhs) const
  {
    ...
    if (!(overwrite == rhs.overwrite))
      return false;
    if (__isset.source_disk_tag != rhs.__isset.source_disk_tag)
      return false;
    else if (__isset.source_disk_tag && !(source_disk_tag == rhs.source_disk_tag))
      return false;
...
typedef struct _get_file_size_request__isset {
  _get_file_size_request__isset() : source(false), dst_dir(false), file_list(false), source_dir(false), overwrite(false), source_disk_tag(false), dest_disk_tag(false), pid(false) {}
  bool source :1;
  bool dst_dir :1;
  bool file_list :1;
  bool source_dir :1;
...
class get_file_size_request {
 public:
  ...
  get_file_size_request() : dst_dir(), source_dir(), overwrite(0), source_disk_tag(), dest_disk_tag() {
  }
  ...
  void __set_dest_disk_tag(const std::string& val);
  ...
  bool operator == (const get_file_size_request & rhs) const
  {
    ...
    if (__isset.source_disk_tag != rhs.__isset.source_disk_tag)
      ...
      return false;
    if (__isset.dest_disk_tag != rhs.__isset.dest_disk_tag)
      return false;
    else if (__isset.dest_disk_tag && !(dest_disk_tag == rhs.dest_disk_tag))
      return false;
    if (__isset.pid != rhs.__isset.pid)
      return false;
    else if (__isset.pid && !(pid == rhs.pid))
