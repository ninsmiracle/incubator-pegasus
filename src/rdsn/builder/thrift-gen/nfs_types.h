...
typedef struct _copy_request__isset {
  _copy_request__isset() : source(false), source_dir(false), dst_dir(false), file_name(false), offset(false), size(false), is_last(false), overwrite(false), source_disk_tag(false) {}
  bool source :1;
  bool source_dir :1;
  bool dst_dir :1;
  bool file_name :1;
...
typedef struct _get_file_size_request__isset {
  _get_file_size_request__isset() : source(false), dst_dir(false), file_list(false), source_dir(false), overwrite(false), source_disk_tag(false), dest_disk_tag(false) {}
  bool source :1;
  bool dst_dir :1;
  bool file_list :1;
  bool source_dir :1;
