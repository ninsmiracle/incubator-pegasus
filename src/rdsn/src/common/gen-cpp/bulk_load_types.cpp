...
void partition_bulk_load_state::__set_downloaded_file_size(const int32_t val) {
  this->downloaded_file_size = val;
__isset.downloaded_file_size = true;
}
...
uint32_t partition_bulk_load_state::read(::apache::thrift::protocol::TProtocol* iprot) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 6:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          xfer += iprot->readI32(this->downloaded_file_size);
          this->__isset.downloaded_file_size = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        break;
...
uint32_t partition_bulk_load_state::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.downloaded_file_size) {
    xfer += oprot->writeFieldBegin("downloaded_file_size", ::apache::thrift::protocol::T_I32, 6);
    xfer += oprot->writeI32(this->downloaded_file_size);
    xfer += oprot->writeFieldEnd();
  }
  xfer += oprot->writeFieldStop();
  xfer += oprot->writeStructEnd();
...
void swap(partition_bulk_load_state &a, partition_bulk_load_state &b) {
  ...
  swap(a.downloaded_file_size, b.downloaded_file_size);
  swap(a.__isset, b.__isset);
}
...
partition_bulk_load_state::partition_bulk_load_state(const partition_bulk_load_state& other13) {
  ...
  downloaded_file_size = other13.downloaded_file_size;
...
partition_bulk_load_state& partition_bulk_load_state::operator=(const partition_bulk_load_state& other14) {
  ...
  downloaded_file_size = other14.downloaded_file_size;
...
void partition_bulk_load_state::printTo(std::ostream& out) const {
  ...
  out << ", " << "downloaded_file_size="; (__isset.downloaded_file_size ? (out << to_string(downloaded_file_size)) : (out << "<null>"));
  out << ")";
}
...
void bulk_load_response::__set_total_downloaded_file_size(const int32_t val) {
  this->total_downloaded_file_size = val;
__isset.total_downloaded_file_size = true;
}
...
uint32_t bulk_load_response::read(::apache::thrift::protocol::TProtocol* iprot) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 11:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          xfer += iprot->readI32(this->total_downloaded_file_size);
          this->__isset.total_downloaded_file_size = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        break;
...
uint32_t bulk_load_response::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.total_downloaded_file_size) {
    xfer += oprot->writeFieldBegin("total_downloaded_file_size", ::apache::thrift::protocol::T_I32, 11);
    xfer += oprot->writeI32(this->total_downloaded_file_size);
    xfer += oprot->writeFieldEnd();
  }
  xfer += oprot->writeFieldStop();
  xfer += oprot->writeStructEnd();
...
void swap(bulk_load_response &a, bulk_load_response &b) {
  ...
  swap(a.total_downloaded_file_size, b.total_downloaded_file_size);
  swap(a.__isset, b.__isset);
}
...
bulk_load_response::bulk_load_response(const bulk_load_response& other27) {
  ...
  total_downloaded_file_size = other27.total_downloaded_file_size;
...
bulk_load_response& bulk_load_response::operator=(const bulk_load_response& other28) {
  ...
  total_downloaded_file_size = other28.total_downloaded_file_size;
...
void bulk_load_response::printTo(std::ostream& out) const {
  ...
  out << ", " << "total_downloaded_file_size="; (__isset.total_downloaded_file_size ? (out << to_string(total_downloaded_file_size)) : (out << "<null>"));
  out << ")";
}
